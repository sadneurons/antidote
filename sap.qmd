...
implications <- list(c("Fracture + repair","Dementia","Fall"),
		c("Fracture + repair","TIA","Fall"),
		c("Fracture + repair","Infection","Fall"),
		c("Fracture + repair","Anakinra"),
		c("Fracture + repair","Age","Fall"),
		c("Fracture + repair","Comorbidities","Fall"),
		c("Dementia","TIA","Age"),
		c("Dementia","Infection"),
		c("Dementia","Anakinra"),
		c("Dementia","Hospitalisation","Fracture + repair"),
		c("Dementia","Hospitalisation","Fall"),
		c("Dementia","Spinal","Fracture + repair","Comorbidities"),
		c("Dementia","Spinal","Comorbidities","Fall"),
		c("Dementia","GA","Fracture + repair","Comorbidities"),
		c("Dementia","GA","Comorbidities","Fall"),
		c("Dementia","Comorbidities","Age"),
		c("TIA","Infection"),
		c("TIA","Anakinra"),
		c("TIA","Hospitalisation","Fracture + repair"),
		c("TIA","Hospitalisation","Fall"),
		c("TIA","Spinal","Fracture + repair","Comorbidities"),
		c("TIA","Spinal","Comorbidities","Fall"),
		c("TIA","GA","Fracture + repair","Comorbidities"),
		c("TIA","GA","Comorbidities","Fall"),
		c("TIA","Comorbidities","Age"),
		c("Fall","Delirium","Spinal","GA","Fracture + repair","Infection","Dementia","TIA","Anakinra","Age"),
		c("Fall","Delirium","Fracture + repair","Infection","Dementia","TIA","Age","Comorbidities"),
		c("Fall","Anakinra"),
		c("Fall","Hospitalisation","Fracture + repair"),
		c("Fall","Spinal","Fracture + repair","Comorbidities"),
		c("Fall","GA","Fracture + repair","Comorbidities"),
		c("Infection","Anakinra"),
		c("Infection","Age"),
		c("Infection","Hospitalisation","Fracture + repair"),
		c("Infection","Hospitalisation","Fall"),
		c("Infection","Spinal","Fracture + repair","Comorbidities"),
		c("Infection","Spinal","Comorbidities","Fall"),
		c("Infection","GA","Fracture + repair","Comorbidities"),
		c("Infection","GA","Comorbidities","Fall"),
		c("Infection","Comorbidities"),
		c("Delirium","Comorbidities","Fracture + repair","Dementia","TIA","Infection","Age","Anakinra","GA","Spinal"),
		c("Anakinra","Age"),
		c("Anakinra","Hospitalisation"),
		c("Anakinra","Comorbidities"),
		c("Age","Hospitalisation","Fracture + repair"),
		c("Age","Hospitalisation","Fall"),
		c("Age","Spinal","Fracture + repair","Comorbidities"),
		c("Age","Spinal","Comorbidities","Fall"),
		c("Age","GA","Fracture + repair","Comorbidities"),
		c("Age","GA","Comorbidities","Fall"),
		c("Hospitalisation","Spinal","Fracture + repair"),
		c("Hospitalisation","GA","Fracture + repair"),
		c("Hospitalisation","Comorbidities","Fall"),
		c("Hospitalisation","Comorbidities","Fracture + repair"),
		c("Spinal","GA","Fracture + repair","Comorbidities","Anakinra"))
	data.frame( implication=unlist(lapply(implications,tos)),
		pvalue=unlist( lapply( implications, tst ) ) )

}

delirium_dag <- dagitty("dag {
Age
Anakinra [exposure]
Comorbidities 
Delirium [outcome]
...
Infection 
TIA 
Fracture_repair -> Delirium
Fracture_repair -> GA/Spinal
Fracture_repair -> Hospitalisation
Age -> Comorbidities
Age -> Delirium
Age -> Dementia
Age -> Fall
...
Anakinra -> Delirium
Comorbidities -> Fall
Comorbidities -> GA/Spinal
Dementia -> Delirium
Dementia -> Fall
Fall -> Fracture_repair
GA/Spinal -> Delirium
Hospitalisation -> Delirium
Infection -> Delirium
Infection -> Fall
TIA -> Delirium
TIA -> Fall
...
![OSLA](images/Delirium-assessment-tool-OSLA.png){fig-align="center"} The OSLA scale is a 4-item scale with a minimum score of 0 and a maximum score of 15. Items respectively have a range of :
